 ...
 **
 *
 *  19/10/2012 - added to track using google this event - function found js/track/tracking.feature.js
 *
 */
	...
	$.extend(F, {
		...
		next: function ( direction ) {
			...
			if (current) {
				...
				// added to track using google this event - function found tracking.feature.js
				trackfeaturegallerynext();
			}
		},
